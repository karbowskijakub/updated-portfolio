      ...
      <div className="about-container">
        ...
        <div className="w-full lg:w-1/2 py-5 lg:p-5 z-0">
          ...
          <p className="mt-5 ternary_text">
            Nazywam się{" "}
            <span className="text-primary-orange">Jakub Karbowski</span>, swoją
            przygodę z programowaniem rozpocząłem w czerwcu 2021 roku i od
            tamtej pory stanowi nieodłączną część mojego życia. To fascynujące
            hobby pochłania mnie każdego dnia. Nieustannie poszerzam swoje
            horyzonty, zgłębiając nowe technologie, które później implementuję w
            moich najnowszych projektach.
          </p>

          <p className="mt-5 ternary_text">
            Dążę zawsze do tego, aby moje prace były przejrzyste i intuicyjne
            dla użytkownika, zapewniając im wygodę i przyjemność z użytkowania.
            Niezależnie od skali projektu, dbam o każdy detal, aby zapewnić
            doskonałą jakość i funkcjonalność.
          </p>
